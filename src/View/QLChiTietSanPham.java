...
public class QLChiTietSanPham extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(189, 240, 161));

        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("MT-Shirt");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(51, 190, 117));
        jLabel3.setText("Bán hàng");

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 190, 117));
        jLabel4.setText("Khách hàng");

        jLabel5.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(51, 190, 117));
        jLabel5.setText("Nhân viên");

        jLabel6.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(51, 190, 117));
        jLabel6.setText("Hóa đơn");

        jLabel7.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(51, 190, 117));
        jLabel7.setText("Sản phẩm");

        jLabel8.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(51, 190, 117));
        jLabel8.setText("Voucher");

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(51, 190, 117));
        jLabel9.setText("Thống kê");

        jLabel10.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(51, 190, 117));
        ...
        jTable1.setForeground(new java.awt.Color(203, 233, 216));
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã áo", "Tên áo", "Thương Hiệu", "Danh Muc", "Màu sắc", "Kích cỡ", "Số lượng", "Giá nhập", "Giá bán", "Ngày nhập", "Hình ảnh", "Trạng thái"
            }
        ));
        jTable1.setToolTipText("");
        jTable1.setGridColor(new java.awt.Color(203, 233, 216));
        jTable1.setSelectionBackground(new java.awt.Color(203, 233, 216));
